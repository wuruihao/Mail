...
protocol FoldingSectionHeaderDelegate {
    ...
    func foldingSectionHeaderTappedAtIndex(index: NSInteger, isOpen:Bool)
}
...
class FoldingSectionHeader: UIView {
    ...
    func setup(backgroundColor:UIColor, titleString:String, titleColor:UIColor, titleFont:UIFont, descriptionString:String, descriptionColor:UIColor, descriptionFont:UIFont, arrowImage:UIImage, currentIsOpen:Bool){
