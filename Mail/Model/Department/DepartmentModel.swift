...
class DepartmentCoreData: NSObject {
    ...
    func saveCoreDate(){
        ...
        //创建一个实例并给属性赋值
        let entity = NSEntityDescription.insertNewObjectForEntityForName("Contacts", inManagedObjectContext: context)as! ContactsEntity
